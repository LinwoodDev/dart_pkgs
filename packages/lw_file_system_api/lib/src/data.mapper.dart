...
class ArchiveStateMapper extends ClassMapperBase<ArchiveState> {
  ...
  static const Field<ArchiveState, Map<String, Uint8List>> _f$added =
      Field('added', _$added, opt: true, def: const {});
...
mixin ArchiveStateMappable {
  String toJson() {
    return ArchiveStateMapper.ensureInitialized()
        .encodeJson<ArchiveState>(this as ArchiveState);
  }

  Map<String, dynamic> toMap() {
    return ArchiveStateMapper.ensureInitialized()
        .encodeMap<ArchiveState>(this as ArchiveState);
  }
  ...
  String toString() {
    return ArchiveStateMapper.ensureInitialized()
        .stringifyValue(this as ArchiveState);
  }

  @override
  bool operator ==(Object other) {
    return ArchiveStateMapper.ensureInitialized()
        .equalsValue(this as ArchiveState, other);
  }

  @override
  int get hashCode {
    return ArchiveStateMapper.ensureInitialized()
        .hashValue(this as ArchiveState);
  }
}
